...
def get_JD_naifen_List_Url(url):  #获取奶粉查询页面中每种商品的连接
    try:
...
def main(offset):
    url = 'https://search.jd.com/Search?keyword=%E5%A5%B6%E7%B2%89&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=%E5%A5%B6%E7%B2%89&page='+ str(offset*2-1)
    print(url)
